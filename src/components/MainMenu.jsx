...
import { User, Play, ShieldAlert, Cpu, Gamepad2 } from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-2xl flex flex-col gap-6 items-center">
      ...
      <div className="text-center mb-2">
        <h1 className="text-4xl md:text-5xl font-black tracking-wider text-neon-glow uppercase mb-2">
          ⚡️ TAP TAP <span className="gradient-text">CLICKER</span> ⚡️
        </h1>
        <p className="text-slate-500 font-semibold md:text-base">
          Trò chơi nhấp chuột giải trí đỉnh cao - Chơi đơn & Đồng đội thời gian thực!
        </p>
      </div>
          ...
          <form onSubmit={handleSave} className="flex flex-col md:flex-row gap-3 items-center justify-between">
            <div className="flex items-center gap-2 bg-slate-50 px-4 py-2.5 rounded-xl border border-slate-200 w-full md:w-auto flex-grow">
              ...
              <input
                ...
                className="bg-transparent border-none outline-none text-slate-800 w-full placeholder-slate-400 font-bold"
                maxLength={16}
                required
              />
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
        ...
        <div className="glass-panel p-6 flex flex-col justify-between items-center text-center relative overflow-hidden group">
          ...
          <div className="my-4">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">
              Luyện ngón tay click chuột, tích luỹ tiền vàng và nâng cấp các máy auto đập tài nguyên tự động mọi lúc mọi nơi!
            </p>
          </div>
          ...
          <button
            ...
            className="btn-primary w-full mt-4 bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 shadow-rose-500/10"
          >
        ...
        <div className={`glass-panel p-6 flex flex-col justify-between items-center text-center relative overflow-hidden group ${!isOnline ? 'bg-slate-50/70 border-slate-100' : ''}`}>
          ...
          <div className="my-4">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">
              Tạo phòng đấu trường so tài click chuột 3 người thời gian thực hoặc phòng hợp tác đặc biệt để cùng thu hoạch tài nguyên nâng cấp chung.
            </p>
          </div>
          ...
          {!isOnline ? (
            <div className="flex items-center gap-2 justify-center text-xs text-rose-600 bg-rose-50 py-2.5 px-4 rounded-xl border border-rose-100 mt-4 w-full font-bold">
              <ShieldAlert size={14} /> Vui lòng kết nối mạng để mở khóa Online
            </div>
          ) : (
        ...
        <div className="w-full glass-panel p-5 text-center">
          ...
          <form onSubmit={triggerJoin} className="flex flex-col md:flex-row gap-3 justify-center items-center">
            <input
              ...
              maxLength={6}
              className="bg-slate-50 px-4 py-2.5 rounded-xl border border-slate-200 font-black tracking-widest text-center text-slate-800 placeholder-slate-400 outline-none focus:border-purple-500 w-full md:w-48 text-base"
              disabled={isEditingName}
            />
            <button
              type="submit"
